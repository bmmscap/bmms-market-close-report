    ...
    return (
        <header className="mb-6">
            <div className="flex justify-between items-center flex-wrap gap-4">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Market Closing Report</h1>
                    <p className="text-lg text-slate-600">{reportDate}</p>
                </div>
                <button
                    onClick={onGenerateReport}
                    disabled={isLoading}
                    className="bg-sky-600 hover:bg-sky-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300 disabled:bg-sky-400 disabled:cursor-not-allowed flex items-center"
                >
